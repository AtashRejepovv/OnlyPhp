...
{  
    ...
    $nomer=strip_tags(htmlspecialchars($_POST['nomer']));
         ...
         mysql_query ("UPDATE  teacher     SET      name ='$name',
                                                            derejesi = '$derejesi',
                                                            welayat = '$welayat',
                                                            etrap = '$etrap',
                                                            wezipesi = '$wezipesi',
...
<div id="timedisplay" style="margin-top: 7%; background-color: lightgreen; height: 4%; "></div> &nbsp    
        ...
        <div class="container-fluid" style="margin-top: 5%; width: 90%">
          ...
          <?php
              ...
              $sql=mysql_query("SELECT * FROM teacher WHERE id='$id'");
 ...
 <div class="col-md-9 personal-info">
        ...
        <form method=POST action="teachers_profile.php?id=<?=$row['id']?>" id="tab">
          ...
          <label style="color:black" class="col-lg-3 control-label">Ady</label>
            ...
            <input type="text" name="name" value="<?=$row['name']?>" class="form-control">
             ...
             <div class="form-group">
            <label style="color:black" class="col-lg-3 control-label">Derejesi</label>
              <div class="col-lg-8">
            <input type="text" name="derejesi" value="<?=$row['derejesi']?>" class="form-control">
              </div>

               <div class="form-group">
            <label style="color:black" class="col-lg-3 control-label">Wezipesi</label>
              <div class="col-lg-8">
            <input type="text" name="wezipesi" value="<?=$row['wezipesi']?>" class="form-control">
              </div>

              <div class="form-group">
            <label style="color:black" class="col-lg-3 control-label">Welaýat</label>
              <div class="col-lg-8">
            <input type="text" name="welayat" value="<?=$row['welayat']?>" class="form-control">
              </div>

              <div class="form-group">
             <label style="color:black" class="col-lg-3 control-label">Etrap</label>
               <div class="col-lg-8">
            <input type="text" name="etrap" value="<?=$row['etrap']?>" class="form-control">
              </div>

              <div class="form-group">
             <label style="color:black" class="col-lg-3 control-label">Pas_num</label>
              <div class="col-lg-8">
            <input type="text" name="pas_num" value="<?=$row['pas_num']?>" class="form-control">
              </div>

              <div class="form-group">
             <label style="color:black" class="col-lg-3 control-label">Nomeri</label>
               <div class="col-lg-8">
            <input type="text" name="nomer" value="<?=$row['nomer']?>" class="form-control">
              </div>
         ...
         <div class="form-group">
            ...
            <div class="col-md-8">
              <a class="btn btn-outline-info" data-toggle="tooltip" title="Yza gaýtmak" href="teacher.php"><i class="fa fa-arrow-circle-left"></i>
