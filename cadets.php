...
//delete accaunt
 if(isset($_GET['ide'])){
 	 $id=$_GET['ide'];
 	 mysql_query("DELETE FROM  cadet WHERE id= '$id'");
 ...
 <?php if($_SESSION['role_id']==0 or $_SESSION['role_id']==1):{ ?>
          <!-- DataTales Example -->
           <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h3 class="m-0 font-weight-bold text-primary">Talyplar arhiwi</h3>
               <div class="col col-xs-6 text-right"> 
                 
                  <a title="Täze talyp goşmak" href="add_cadet.php" class="btn btn-success btn-icon-split">
  ...
  <thead>
    <tr>
      ...
      <th class="th-sm">Hünäri</th>    
      <th class="th-sm">Bölümi</th> 
      <th class="th-sm">Welaýaty</th>
      <th class="th-sm">Etraby</th>
  ...
  <tbody>
                      ...
                      ?>
                       ...
                       <td align="center">
                              ...
                              <a title="Aýyrmak" onclick="return confirm('DELETE?')" href="cadets.php?ide=<?=$row['id']?>"  class="btn btn-outline-danger"><i class="fas fa-trash-alt"></i></a>
