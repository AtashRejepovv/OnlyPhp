...
{  
    ...
    $nomer=strip_tags(htmlspecialchars($_POST['nomer']));
         ...
         mysql_query ("UPDATE  cadet     SET      name ='$name',
                                                          wezipesi = '$wezipesi',
                                                          hunari = '$hunari',
                                                          welayat = '$welayat',
                                                          etrap = '$etrap',
...
<div id="timedisplay" style="margin-top: 7%; background-color: lightgreen; height: 4%; "></div> &nbsp  
        ...
        <div class="container-fluid" style="margin-top: 5%; width: 90%">
          ...
          <?php
              ...
              $sql=mysql_query("SELECT * FROM cadet WHERE id='$id'");
 ...
 <div class="col-md-9 personal-info">
        ...
        <form method=POST action="cadets_profile.php?id=<?=$row['id']?>" id="tab">
        <div class="form-group">
         <label style="color:black" class="col-lg-3 control-label" >Ady</label>
          ...
          <label style="color:black" class="col-lg-3 control-label">Nomeri</label>
            ...
            <div class="col-md-8">
              <a class="btn btn-outline-info" data-toggle="tooltip" title="Yza gaýtmak" href="cadets.php"><i class="fa fa-arrow-circle-left"></i>
